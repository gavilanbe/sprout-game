...
const TXT = {
  ...
  elderBlade:[ "¡La Hoja te\nsienta bien,\nbrote!",
               ...
               "Otras 3 duermen\nbajo arbustos\nque BRILLAN.",
               "Pulsa ENTER para\nabrir el zurrón:\nallí verás el mapa\ny tus misiones." ],
  elderWin:[ "¡Las 8 semillas! Mira la copa: vuelven a casa...",
             "¡El Roble respira! Y el valle florece con él.",
             ...
             "Tráeme la Brasa. El Roble ya tiene fuerza para sostenerla.",
  ...
  flakeGet:[ "¡El COPO ETERNO!",
             "No se derrite\njamás. Late frío\ny tristísimo.",
             "El Viento ya no\naúlla. Llévaselo\nal anciano." ],
  thaw:[ "¡La Brasa! Siente cómo late el deshielo...",
         "Descansará en el ALTAR DE PRIMAVERA, junto al Roble. Mira: las montañas reverdecen.",
